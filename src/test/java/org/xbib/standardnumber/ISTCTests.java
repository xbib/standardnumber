...
public class ISTCTests {
    ...
    public void testISTC() throws Exception {
        StandardNumber istc = new ISTC().set("0A920021223F3320").normalize().verify();
    ...
    public void testISTC2() throws Exception {
        StandardNumber istc = new ISTC().set("ISTC A02-2009-000004BE-A").normalize().verify();
    ...
    public void testISTC3() throws Exception {
        StandardNumber istc = new ISTC().set("ISTC 0A9 2009 12B4A105 C").normalize().verify();
    ...
    public void testISTC4() throws Exception {
        StandardNumber istc = new ISTC().set("ISTC 0A9-2002-12B4A105-7").normalize().verify();
    ...
    public void testISTC5() throws Exception {
        StandardNumber istc = new ISTC().set("A02200900000A87C").normalize().verify();
    ...
    public void testISTC6() throws Exception {
        StandardNumber istc = new ISTC().set("ISTC A02-2010-31F4CB2C-B").normalize().verify();
